...
public class App
{
    ...
    public static void main( String[] args ) throws IOException {
        PdfReader reader = new PdfReader("C:\\Users\\Nick\\IdeaProjects\\Adventurer\\resources\\tbontb-regular.pdf");

        GraphDatabaseService graphDb = new GraphDatabaseFactory().newEmbeddedDatabaseBuilder( "C:\\Users\\Nick\\IdeaProjects\\Adventurer\\graph-db").newGraphDatabase();
        ...
        try ( Transaction tx = graphDb.beginTx() )
        {
            ...
            for (int page = 1 + PAGE_OFFSET; page <= reader.getNumberOfPages(); page++) {
                ...
                if (strategy.getResultantText().indexOf("THE END") != -1) {
